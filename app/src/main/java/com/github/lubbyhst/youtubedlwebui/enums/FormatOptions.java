...
public enum FormatOptions {
    ...
    VIDEO_MMI("bestvideo[height<=576]+bestaudio/best[height<=576][ext=mp4] --recode-video mp4 --prefer-ffmpeg", "Video MMI special"),
    VIDEO_SD("bestvideo[height<=480]+bestaudio/best[height<=480][ext=mp4]", "Video 480p mp4"),
    AUDIO_ONLY("bestaudio[ext=mp3]", "Audio mp3");
